...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/mirror": {
            "get": {
                ...
                "description": "GET returns the persisted cadence + live count of\nenabled destinations. PATCH validates and applies\nstatus_poll_sec, hot-swaps the background poller\n(stops the old one, starts a new one with the\nconfigured cadence; 0 disables and tears the poller\ndown without replacement), and persists to gigot.json.\nBound: 0 ≤ status_poll_sec ≤ 86400 (one day cap;\nlonger cadences should disable the poller and rely\non the manual Refresh button instead).",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/server.MirrorSettingsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "GET / PATCH response",
                        "schema": {
                            "$ref": "#/definitions/server.MirrorSettingsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/admin/repos/{name}/destinations/{id}/status/refresh": {
            "post": {
                ...
                "description": "Invokes ` + "`" + `git ls-remote --refs` + "`" + ` against the destination's URL\nusing the vault credential referenced by ` + "`" + `credential_name` + "`" + `,\ncompares the result against local refs/heads/* + refs/audit/*,\nand writes the outcome onto the destination as\n` + "`" + `remote_status` + "`" + `, ` + "`" + `remote_checked_at` + "`" + `, optional\n` + "`" + `remote_check_error` + "`" + `, and per-ref ` + "`" + `remote_refs[]` + "`" + `. Returns the\nupdated destination view. No push is performed — this is the\nread-side companion to /sync. Disabled destinations still\naccept this call (manual is explicit operator intent); the\nflag gates only the post-receive auto-mirror.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    ...
                    "502": {
                        "description": "ls-remote failed (auth/network); the destination is still updated with status=error so the admin UI badge reflects it",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "description": "Filter by effective tag (repeatable; OR across values)",
                        "name": "tag",
                        "in": "query"
                    },
                    {
        ...
        "/repos/{name}/destinations/{id}/status/refresh": {
            "post": {
                "security": [
                    {
                        "SessionAuth": []
        ...
        "/repos/{name}/formidable": {
            "get": {
                ...
                "description": "One-call read of the Formidable-specific shape of a\nrepo: scaffold marker (version/by/at), templates list\nunder templates/, and storage layout under storage/.\nNon-Formidable repos return 200 with marker_present\nfalse and empty arrays so clients can distinguish\n\"not Formidable\" from \"doesn't exist\" or \"no access.\"",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.RepoFormidableResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "server.DestinationView": {
            ...
            "properties": {
                ...
                "remote_refs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.RemoteRefStatusView"
                    }
                },
                "remote_status": {
                    "type": "string"
        ...
        "server.RepoFormidableResponse": {
            "type": "object",
            "properties": {
                "marker": {
                    "$ref": "#/definitions/server.FormidableMarkerView"
                },
                "marker_present": {
                    "type": "boolean"
                },
                "storage": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.FormidableStorage"
                    }
                },
                "templates": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.FormidableTemplate"
                    }
                }
            }
        },
